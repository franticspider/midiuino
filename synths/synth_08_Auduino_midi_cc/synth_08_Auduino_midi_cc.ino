...
//  #define SYNC_CONTROL         (4)      //   pitch now controlled by midi notes 
...
//  grain2Decay    = analogRead(GRAIN2_DECAY_CONTROL) / 4; 
  ...
  grainPhaseInc  = mapPhaseInc(grainPhaseIncMidiCC); // midi controller data is 7 bits analog in is 8 bit ... so 1/2 the range 
  grainDecay     = (grainDecayMidiCC + 4) / 4;       // original is above +4 is to stop whistling 
