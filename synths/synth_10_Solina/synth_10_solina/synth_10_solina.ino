...
uint32_t NOTES[12]={
  208065>>2,220472>>2,233516>>2,247514>>2,262149>>2,277738>>2
...
const uint8_t ATTrates[32]={
   1,    2,    3,    4,    5,    8,   12,   20,   32,   37,
  43,   51,   64,   85,  128,  255, 0xFF, 0xFF, 0xFF, 0xFF,
...
const uint8_t RELrates[32]={
  1,    2,    3,    4,    5,    8,   12,   20,   32,   37,
 43,   51,   64,   85,  128,  255,  255,  128,   85,   64,
 51,   43,   37,   32,   20,   12,    8,    5,    4,    3,
  2,    1
 };

const uint8_t sinetable[256] PROGMEM = {
127,  130,  133,  136,  139,  143,  146,  149,  152,  155,
158,  161,  164,  167,  170,  173,  176,  178,  
...
ISR(TIMER1_COMPA_vect) {
  ...
  for (uint8_t i=0;i<8;i++) {
    if (integrators[i]) 
      integrators[i]--; //Decrement integrators
